...
const MODEL_REGISTRY = Object.freeze({
  ...
  'gemma4:31b': { name: 'Gemma 4', provider: 'Ollama', plan: 'basic' },
  'qwen3.5:397b': { name: 'Qwen 3.5', provider: 'Ollama', plan: 'pro' },
  'minimax-m2.7': { name: 'MiniMax M2.7', provider: 'Ollama', plan: 'plus' },
  'nemotron-3-super': { name: 'Nemotron 3 Super', provider: 'Ollama', plan: 'plus' },
  'nemotron-3-nano:30b': { name: 'Nemotron 3 Nano', provider: 'Ollama', plan: 'basic' },
  'mistral-large-3:675b': { name: 'Mistral Large 3', provider: 'Ollama', plan: 'pro' },
