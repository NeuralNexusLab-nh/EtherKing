...
const QUOTA_WINDOWS = Object.freeze({
  fiveHour: Object.freeze({ label: '5-hour limit', capacity: 150, durationMs: 5 * 60 * 60 * 1000 }),
  weekly: Object.freeze({ label: 'Weekly limit', capacity: 900, durationMs: 7 * 24 * 60 * 60 * 1000 })
});
